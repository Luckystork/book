    ...
    switch (uMsg) {
        case WM_CREATE: {
            ...
            g_hBtnSave = CreateWindowA("BUTTON", "SAVE & RETURN", WS_CHILD | WS_VISIBLE | BS_FLAT, 
                          125, 140, 150, 30, hwnd, (HMENU)BTN_SAVE, GetModuleHandle(NULL), NULL);
        ...
        case WM_PAINT: {
            ...
            // Background (Winter Glass Pure Snow/Light Frost)
        ...
        case WM_CTLCOLORSTATIC: {
            // Make the static text elements (if any) transparent to background
